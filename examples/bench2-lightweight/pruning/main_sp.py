...
if __name__ == '__main__':
    ...
    pruned_model = pruner.prune(args.threshold)

    test_acc, _ = testing(model, test_loader, criterion, device)
    print(f'After pruning, Test Acc. {test_acc:.2f}%')

    print("#Params of original model:", pruner.count_params(pruner.original_model))
    print("#Params of pruned model:", pruner.count_params(pruned_model))